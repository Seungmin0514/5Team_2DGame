...
public class AnimationClipChanger : MonoBehaviour
{
    ...
    public void SwitchToTypeA() => SwitchToSet(CharacterTypeA);
    public void SwitchToTypeB() => SwitchToSet(CharacterTypeB);
    public void SwitchToTypeC() => SwitchToSet(CharacterTypeC);
